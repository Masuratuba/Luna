-- Reconcile action/event/audit persistence for environments where the original
-- migration was committed but not applied yet. Idempotent by design.
...
grant select, insert, update, delete on public.luna_events to authenticated;
grant select, insert, update, delete on public.luna_audit_log to authenticated;
